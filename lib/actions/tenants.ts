...
// Section 8 â€” Tenant Management.
// Section 10 â€” status transitions route through transitionTenant() only.
...
export async function createTenant(_prev: ActionState, formData: FormData): Promise<ActionState> {
  ...
  // Property is derived from the unit rather than submitted separately â€”
  ...
  // Decision D1 â€” one live tenant per unit.
  ...
  try {
    const created = await prisma.tenant.create({
      data: {
        ...
        unitId: unit.id,
        // Section 10 step 1 â€” new tenant is always PENDING.
        status: "PENDING",
      },
    ...
    // Section 13 â€” the creation itself is a traceable event.
    ...
    // Section 12, Automation 1 â€” New Tenant Notification.
